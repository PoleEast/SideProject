...
namespace AssetTracker.Services
{
    ...
    {
        public async Task<Result<ExchangeRateHistory>> GetExchangeRate(CurrencyType currencyType)
        {
            ...
            var apiResult = await exchangeRateApiClient.GetExchangeRateToUSD(currencyType);
